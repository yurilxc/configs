...
(defun color-theme-jsc-dark ()
  ...
  (color-theme-install
   '(color-theme-jsc-dark
    ...
    (font-lock-builtin-face ((t (:bold t :foreground "LightSteelBlue"))));;LightSteelBlue   include declare等
    (font-lock-comment-face ((t (:italic t :foreground "#70CC55"))))
    (font-lock-constant-face ((t (:bold t :foreground "salmon"))));;salmon
    (font-lock-function-name-face ((t (:bold t :foreground "orange"))));;orange
    (font-lock-keyword-face ((t (:bold t :foreground "#4242FF"))))
    (font-lock-string-face ((t (:italic t :foreground "orange"))));;orange
    (font-lock-type-face ((t (:bold t :foreground "gold"))))
    (font-lock-variable-name-face ((t (:italic t :bold t :foreground "#FF5151"))));;light salmon
