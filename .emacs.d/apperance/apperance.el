(defun frame-setting()
  ;; tranparency
  ;; first arg: foreground, second arg: background
  (set-frame-parameter (selected-frame) 'alpha (list 77 77))
  ;; font
  (set-frame-font "DejaVu Sans Mono:pixelsize=16:foundry=unknown:weight=normal:slant=normal:width=normal:spacing=100:scalable=true"))
...
;;edit from (color-theme-billw)
(require 'color-theme)
(defun color-theme-septem ()
  "Cornsilk on black.
  ...
  (color-theme-install
   '(color-theme-billw
     ((foreground-color . "cornsilk")
      ...
      (border-color . "black"))
     (default ((t (nil))))
     (isearch ((t (:background "indian red" :foreground "lemon chiffon"))))
     ...
     ;; (region ((t (:background "dark"))))
     (secondary-selection ((t (:background "deepskyblue4"))))
     (underline ((t (:underline t))))
     (info-node ((t (:foreground "orange" :bold t :italic t))))
     (info-menu-5 ((t (:underline t))))
     (info-xref ((t (:foreground "orange" :bold t))))
     ...
     (font-lock-variable-name-face ((t (:foreground "rosy brown"))))
     (font-lock-type-face ((t (:foreground "plum"))))
     (font-lock-constant-face ((t (:foreground "dark salmon"))))
